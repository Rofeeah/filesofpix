...
INCLUDES = restoration.h, decoder.h, convert.h
...
CFLAGS =  -g -std=c99 -Wall -Wextra $(IFLAGS)
LIBS = $(CIILIBS) -lm    
...
#    executable.
#
restoration: restoration.o readaline.o decoder.o convert.o
	$(CC) $(LDFLAGS) -o restoration restoration.o readaline.o convert.o decoder.o $(LDLIBS)

testing: testing.o readaline.o 
	$(CC) $(LDFLAGS) -o testing testing.o readaline.o 
